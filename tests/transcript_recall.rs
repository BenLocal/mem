//! Integration tests for the transcript-recall path (BM25 + ANN + RRF +
//! session/recency + window hydration). See spec
//! docs/superpowers/specs/2026-05-01-transcript-recall-design.md.
//!
//! The transcript BM25 path is the Tantivy index over
//! `conversation_messages`; `bm25_transcript_candidates` filters
//! `embed_eligible` at query time. Exercised end-to-end below via the
//! public `Store` API.
